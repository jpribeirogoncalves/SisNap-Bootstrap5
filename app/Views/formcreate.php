...
<body>
  ...
  <div class="container" style="margin-top: 50px;">
    <div id="login">
      <div class="card">
        <?php echo form_open('usuarios/storeCreate'); ?>
        <div class="card-body">
          <h2 class="card-title">Cadastrar</h2>
          <div class="alert alert-danger text-center" id="aviso-matricula" style="display:none;">
            <strong><?php echo $message_erro ?? ''; ?></strong>
          </div>
          <script>
            <?php if (isset($message_erro) && $message_erro !== '') : ?>
              document.getElementById('aviso-matricula').style.display = 'block';
              ...
              setTimeout(function() {
                document.getElementById('aviso-matricula').style.display = 'none';
              }, tempoExibicao);
            <?php endif; ?>
          </script>
          ...
          <div class="card-content-area mb-3">
            <fieldset>
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="perfil" id="usuario" value="usuario" required <?php if (isset($usuarios['perfil']) && $usuarios['perfil'] == "usuario") echo "checked" ?>>
                <label class="form-check-label" for="usuario">Usuário</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="perfil" id="admin" value="admin" required <?php if (isset($usuarios['perfil']) && $usuarios['perfil'] == "admin") echo "checked" ?>>
