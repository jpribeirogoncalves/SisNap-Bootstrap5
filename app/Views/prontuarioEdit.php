...
<head>
    ...
    <title>Prontuario Edit | SisNap</title>
</head>
    ...
    <main>
        <div class="container" style="margin-top: 50px;">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <form class="formulario" method="post" action="<?php echo base_url('historico_prontuario/storeEdit'); ?>">
                        <?php echo csrf_field(); ?>
                        <h1>Editar - Ficha de Prontuário</h1>
                        <div class="mb-3">
