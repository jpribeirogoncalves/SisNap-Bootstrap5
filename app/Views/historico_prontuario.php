            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav ms-auto" style="margin-bottom: 10px;">
                        <li class="nav-item">
                            <a class="nav-link btn btn-light text-dark" href="<?= base_url('index.php/historico_prontuario/create') ?>" title="Cadastrar Usuário">
    ...
    <main>
        <div class="container">
            <div class="text-center mt-4">
                <h2>Gerenciamento das fichas de Prontuário</h2>
            </div>
            ...
            <div class="row mt-2">
                <div class="col">
                    <form method="GET" action="<?= base_url('index.php/historico_prontuario/search') ?>" class="d-flex justify-content-center">
                ...
                <div class="col text-end">
                    <a href="<?= base_url('index.php/historico_prontuario') ?>" class="btn btn-danger">
            ...
            <div class="table-responsive mt-4">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php foreach ($prontuario as $pront) : ?>
                            <tr>
                                <td><?php echo $pront['id'] ?></td>
                                <td><?php echo $pront['responsavel'] ?></td>
                                <td><?php echo $pront['paciente'] ?></td>
                                <td><?php echo $pront['data'] ?></td>
                                <td class="text-center">
                                    <a href="<?= base_url('index.php/historico_prontuario/edit/' . $pront['id']) ?>" class="btn btn-warning">
                                        <img src="<?= base_url('img/Editar-ficha-Preto.png') ?>" title="Editar" alt="Editar">
                                    </a>
                                    -
                                    <a href="<?= base_url('index.php/historico_prontuario/pdf/' . $pront['id']) ?>" class="btn btn-primary ">
                                        <img src="<?= base_url('img/download-PDF-Preto.png') ?>" title="Gerar PDF" alt="Gerar PDF">
                                    </a>
                                    -
                                    <a href="<?= base_url('index.php/historico_prontuario/delete/' . $pront['id']) ?>" onclick="return confirma()" class="btn btn-danger">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center">
                            <li class="page-item <?php if ($currentPage == 1) echo 'disabled'; ?>">
                                <a class="page-link" href="<?= base_url('index.php/historico_prontuario?page=' . ($currentPage - 1)) ?>">Anterior</a>
                            </li>
                            <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                                <li class="page-item <?php if ($i == $currentPage) echo 'active'; ?>">
                                    <a class="page-link" href="<?= base_url('index.php/historico_prontuario?page=' . $i) ?>"><?php echo $i ?></a>
                                </li>
                            <?php endfor; ?>
                            <li class="page-item <?php if ($currentPage == $totalPages) echo 'disabled'; ?>">
                                <a class="page-link" href="<?= base_url('index.php/historico_prontuario?page=' . ($currentPage + 1)) ?>">Próxima</a>
                            </li>
                        </ul>
                    </nav>
                </div>
